...
class MyTest(unittest.TestCase):
    ...
    def test_treemap8(self):
        ...
        t.put(5, 'five')
        t.put(6, 'six')
        self.assertEqual(t.range_search(3, 6), [(3, 'three'), (4, 'four'), (5, 'five')])
    ...
    def test_classmates(self):
        filename = '/home/gradzilla/uploads/submissions/grader_programs/CPE202/Lab_5/Spring2020/classmates.tsv'
        t = import_classmates(filename)
        self.assertEqual(t.size(), 52)
        v = search_classmate(t, 52)
